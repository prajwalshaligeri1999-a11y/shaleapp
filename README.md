...
![Screen 3 Student](screen3(1).png)

### Screen 4 – Parent Login Screen
![Screen 3 Parent](screen3(2).png)

### Screen 5 – Student Registration Screen
![Screen 4 Student](screen4(1).png)

### Screen 6 – Parent Registration Screen
![Screen 4 Parent](screen4(2).png)

### Screen 7 – English Dashboard Screen
![Dashboard English](dashboard.png)

### Screen 8 – Kannada Dashboard Screen
![Dashboard Kannada](dashboard1.png)
